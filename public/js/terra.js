...
// circa 2016
          ...
          14: [function (require, module, exports) {
                  ...
                  var heightfield_1 = NTS_HEIGHTFIELD;
                  var log = NTS_LOGGER;
                  ...
                  function Player(heightField, waterHeight) {
                      ...
                      function updateAuto(time, dt) {
                          ...
                          var groundHeight = Math.max(heightfield_1.heightAt(heightField, state.pos.x, state.pos.y, true), waterHeight);
                          // Look ahead heights
                          var h1 = Math.max(heightfield_1.heightAt(heightField, _p1.x, _p1.y, true), waterHeight);
                          var h2 = Math.max(heightfield_1.heightAt(heightField, _p2.x, _p2.y, true), waterHeight);
                          var h3 = Math.max(heightfield_1.heightAt(heightField, _p3.x, _p3.y, true), waterHeight);
